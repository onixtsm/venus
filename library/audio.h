...
extern void write_audio_reg(unsigned char u8RegAddr, unsigned char u8Data, int iic_fd);
 ...
 */
extern void audio_bypass(unsigned int audio_mmap_size, unsigned int nsamples, unsigned int volume, int uio_index);
 ...
 * @param   uio_index is the uio index in /dev list.
 */
extern void audio_record(unsigned int audio_mmap_size, unsigned int *BufAddr, unsigned int nsamples, int uio_index);
 ...
 */
extern void audio_play(unsigned int audio_mmap_size, unsigned int *BufAddr, unsigned int nsamples, unsigned int volume,
                       int uio_index);
...
extern void audio_repeat_play(unsigned int audio_mmap_size, unsigned int *BufAddr, unsigned int nsamples, unsigned int volume,
 ...
 * @param   volume is the volume of the output.
 */
extern void audio_generate_tone(unsigned int frequency, uint32_t time_ms, unsigned int volume);
