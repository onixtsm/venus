...
#define XIic_Send10BitAddrByte1(SlaveAddress, Operation)                          \
  {                                                                               \
    ...
    XIic_WriteReg(InstancePtr->BaseAddress, XIIC_DTR_REG_OFFSET, (u32)LocalAddr); \
  }
 ...
 *
 ******************************************************************************/
#define XIic_Send10BitAddrByte2(SlaveAddress) XIic_WriteReg(InstancePtr->BaseAddress, XIIC_DTR_REG_OFFSET, (u32)(SlaveAddress));
...
#define XIic_FlushRxFifo(InstancePtr)                                                 \
  {                                                                                   \
    int LoopCnt;                                                                      \
    u8 BytesToRead = XIic_ReadReg(InstancePtr->BaseAddress, XIIC_RFO_REG_OFFSET) + 1; \
...
#define XIic_FlushTxFifo(InstancePtr)                                                                  \
  ...
  {                                                                                                    \
    ...
    XIic_WriteReg(InstancePtr->BaseAddress, XIIC_CR_REG_OFFSET, CntlReg | XIIC_CR_TX_FIFO_RESET_MASK); \
...
#define XIic_ReadRecvByte(InstancePtr)                                                           \
  {                                                                                              \
    *InstancePtr->RecvBufferPtr++ = XIic_ReadReg(InstancePtr->BaseAddress, XIIC_DRR_REG_OFFSET); \
