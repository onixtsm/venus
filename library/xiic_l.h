...
#define XIic_DynSend7BitAddress(BaseAddress, SlaveAddress, Operation)                    \
  {                                                                                      \
    u8 LocalAddr = (u8)(SlaveAddress << 1);                                              \
    LocalAddr = (LocalAddr & 0xFE) | (Operation);                                        \
    XIic_WriteReg(BaseAddress, XIIC_DTR_REG_OFFSET, XIIC_TX_DYN_START_MASK | LocalAddr); \
  }
...
#define XIic_DynSendStartStopAddress(BaseAddress, SlaveAddress, Operation)                                       \
  {                                                                                                              \
    u8 LocalAddr = (u8)(SlaveAddress << 1);                                                                      \
    LocalAddr = (LocalAddr & 0xFE) | (Operation);                                                                \
    XIic_WriteReg(BaseAddress, XIIC_DTR_REG_OFFSET, XIIC_TX_DYN_START_MASK | XIIC_TX_DYN_STOP_MASK | LocalAddr); \
  }
...
#define XIic_DynSendStop(BaseAddress, ByteCount) \
  { XIic_WriteReg(BaseAddress, XIIC_DTR_REG_OFFSET, XIIC_TX_DYN_STOP_MASK | ByteCount); }
